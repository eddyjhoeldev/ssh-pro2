#!/bin/bash
wget https://raw.githubusercontent.com/eddyjhoeldev/ssh-pro/master/Install/list > /dev/null 2>&1
wget https://raw.githubusercontent.com/eddyjhoeldev/ssh-pro/master/versao -O /bin/versao > /dev/null 2>&1
wget https://raw.githubusercontent.com/eddyjhoeldev/ssh-pro/master/Install/licence -O /usr/lib/licence > /dev/null 2>&1
clear
...
echo ""
echo -e "\033[1;31m≠×≠×≠×≠×≠×≠×≠×≠×[\033[1;33m • \033[1;32m@EddyJhoel\033[1;33m •\033[1;31m ]≠×≠×≠×≠×≠×≠×≠×≠×\033[0m"
echo ""
